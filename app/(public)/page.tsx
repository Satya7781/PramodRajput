...
async function getHomepageData() {
  const [eventsRes, newsRes, albumsRes, videosRes] = await Promise.all([
    supabase
      .from('events')
      .select('*')
  ...
  return {
    ...
    albums: (albumsRes.data || []) as PhotoAlbum[],
        ...
        <div className="container relative z-10 mx-auto px-4 lg:px-8 py-20">
          <div className="max-w-2xl animate-slide-up">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition-all hover:scale-105"
              >
                Explore Journey
              ...
              <Link
                href="/events"
                className="inline-flex items-center gap-2 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 px-6 py-3 text-sm font-semibold text-white hover:bg-white/20 transition-all"
              >
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-bold mt-2 mb-6 text-balance">
                जनता की आवाज़, विकास का संकल्प
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-6">
                प्रमोद राजपूत ने अपना जीवन फन्दा कला, भोपाल की जनता की सेवा में समर्पित किया है।
                2009 से राजनीतिक और सामाजिक कार्यों में सक्रिय रहते हुए उन्होंने युवाओं, किसानों
                और ग्रामीण समुदायों के लिए अनेक महत्वपूर्ण पहलें की हैं।
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                जनपद पंचायत फन्दा के अध्यक्ष और भाजपा फन्दा मंडल के मंडल अध्यक्ष के रूप में
                वे निरंतर जनसेवा में अग्रणी हैं। उनका लक्ष्य है — हर नागरिक को विकास के समान
                अवसर और एक बेहतर भविष्य मिले।
              </p>
              <Link
                href="/about"
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              वे मूल सिद्धांत जो इस मिशन को परिभाषित करते हैं और हर पहल को दिशा देते हैं।
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="group rounded-2xl border border-border bg-card p-8 hover:shadow-lg hover:border-primary/30 transition-all animate-slide-up"
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {event.registration_enabled && event.status === 'registration_open' && (
                      <span className="inline-block mt-4 rounded-full bg-secondary/10 text-secondary px-3 py-1 text-xs font-medium">
                        Registration Open
                      </span>
                    )}
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {albums.map((album, i) => (
                <Link
                  key={album.id}
                  href="/gallery/photos"
                  className="group relative aspect-square rounded-xl overflow-hidden hover:shadow-lg transition-all animate-fade-in"
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-primary-foreground/80 max-w-2xl mx-auto mb-8">
            Follow the journey on social media for the latest updates, event coverage, and community stories.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 px-6 py-3 text-sm font-semibold hover:bg-white/20 transition-all">
              Facebook
            </a>
            <a href="#" className="rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 px-6 py-3 text-sm font-semibold hover:bg-white/20 transition-all">
              Twitter
